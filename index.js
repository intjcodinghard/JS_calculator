    ...
    return (
        <div className="container">
            ...
            <div id="display" className="dis">
                ...
                <div id="clear" onClick={clear } className="padButton C tomato">C</div>
                ...
                <div id= "equals" onClick={calculate} className="padButton equal blueonClick={display} ">=</div>
                <div id="zero" onClick={()=> display()} className="padButton zero dark-gray">0</div>
